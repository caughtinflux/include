...
#import <PhotoLibrary/PLCloudSharedAlbumProtocol-Protocol.h>
...
+ (id)_insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 savedAssetType:(long long)arg3 replacementUUID:(id)arg4 imageSource:(CGImageSourceRef *)arg5 imageData:(id *)arg6 isPlaceholder:(_Bool)arg7;
+ (id)insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 savedAssetType:(long long)arg3 replacementUUID:(id)arg4 imageSource:(CGImageSourceRef *)arg5 imageData:(id *)arg6;
+ (id)insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 savedAssetType:(long long)arg3 replacementUUID:(id)arg4 imageSource:(CGImageSourceRef *)arg5 imageData:(id *)arg6 isPlaceholder:(_Bool)arg7;
