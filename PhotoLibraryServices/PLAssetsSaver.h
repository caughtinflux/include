...
- (void)saveImageRef:(CGImageRef)arg1 orientation:(long long)arg2 imageData:(id)arg3 properties:(id)arg4 completionBlock:(id)arg5;
...
- (void)queueJobDictionary:(id)arg1 asset:(id)arg2 requestEnqueuedBlock:(id)arg3 completionBlock:(void)arg4 imageSurface:(id)arg5 previewImageSurface:(void)arg6 slalomRegions:(IOSurfaceRef)arg7;
