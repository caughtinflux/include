...
-(CGFloat)CGFloatValueForKeyIfSupported:(id)arg1 ;
-(void)setPointValue:(CGPoint)arg1 forKeyIfSupported:(id)arg2 ;
-(void)setFloatValue:(CGFloat)arg1 forKeyIfSupported:(id)arg2 ;
...
-(void)handlePinchGesture:(CGFloat)arg1 stateBegan:(BOOL)arg2 ;
-(void)handleRotateGesture:(CGFloat)arg1 stateBegan:(BOOL)arg2 mirror:(BOOL)arg3 ;
@end
