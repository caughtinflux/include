...
@class MFComposeRecipient, MFComposeRecipientView, MFModernComposeRecipientAtom, MFRecentComposeRecipient, NSArray, NSString;
...
- (void)composeRecipientView:(MFComposeRecipientView *)arg1 showPersonCardForRecent:(MFRecentComposeRecipient *)arg2;
