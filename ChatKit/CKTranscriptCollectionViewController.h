...
- (void)applyTranscriptUpdate:(id)arg1 animated:(_Bool)arg2 anchorIndex:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)applyTranscriptUpdate:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
