...
@property(nonatomic) unsigned long long backgroundSendTaskIdentifier; // @synthesize backgroundSendTaskIdentifier=_backgroundSendTaskIdentifier;
...
- (void)setLoadedMessageCount:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
