...
@interface SBStretchTransformer : NSObject
{
    ...
    CGFloat m_stretchFactor;
    id m_animationCompletionHandler;
}

@property(nonatomic) CGFloat stretchFactor; // @synthesize stretchFactor=m_stretchFactor;
...
- (void)updateMeshTransform:(id)arg1 stretchFactor:(CGFloat)arg2;
- (id)meshTransform;
- (void)dealloc;
