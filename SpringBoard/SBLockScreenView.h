...
@interface SBLockScreenView : SBAlertView <UIScrollViewDelegate, SBFGlintyStringViewDelegate, _UISettingsKeyObserver>
{
    ...
    CGFloat _foregroundTranslationY;
    ...
    CGFloat _topGrabberOriginalOriginY;
    CGFloat _bottomGrabberOriginalOriginY;
    CGFloat _currentBlurRadius;
...
- (void)_updateFakeStatusBarsForPercentScrolled:(CGFloat)arg1;
...
- (void)_updateOverlaysForScroll:(CGFloat)arg1;
...
- (void)_adjustTopAndBottomGrabbersForPercentScrolled:(CGFloat)arg1;
- (CGFloat)_bottomGrabberYOriginForPercentScrolled:(CGFloat)arg1;
- (CGFloat)_topGrabberYOriginForPercentScrolled:(CGFloat)arg1;
- (void)_layoutGrabberView:(id)arg1 atTop:(BOOL)arg2 percentScrolled:(CGFloat)arg3;
...
- (void)_setCurrentBlurRadius:(CGFloat)arg1;
- (BOOL)_needsRealBlur;
- (id)_overlayStylePropertiesFromPropertiesFactory:(id)arg1;
- (void)_showFakeWallpaperBlurWithAlpha:(CGFloat)arg1;
...
- (void)setMediaControlsContainerAlpha:(CGFloat)arg1;
...
- (void)slideForegroundVerticallyBy:(CGFloat)arg1;
