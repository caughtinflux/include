...
- (BOOL)isDock;
- (void)enumerateIconViewsUsingBlock:(void(^)(SBIconView *))block;
...
- (void)showAllIcons;
- (SBIcon *)iconAtPoint:(CGPoint)point index:(NSUInteger *)outIdx proposedOrder:(int *)arg3 grabbedIcon:(SBIcon *)icon;
- (SBIcon *)iconAtPoint:(CGPoint)point index:(NSUInteger *)outIdx;
