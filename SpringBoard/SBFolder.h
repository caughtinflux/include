...
@class NSHashTable, NSMutableDictionary, NSMutableSet, NSString, SBIcon, SBFolderIcon, SBIconIndexMutableList;
...
- (void)removeFolderObserver:(id<SBFolderObserver>)obs;
- (void)addFolderObserver:(id<SBFolderObserver>)obs;
