...
@class SBAnimationStepper, SBAppSliderController, SBAppSliderWindowController, SBApplication, SBDismissOnlyAlertItem, SBSwitchAppGestureView, SBWorkspaceEventQueueLockAssertion, UIStatusBar, UIView, UIWindow;
...
+ (CGAffineTransform)_transformAndFrame:(CGRect *)arg1 forStatusBarWithOrientation:(int)arg2 height:(CGFloat)arg3 inJailRect:(CGRect)arg4;
...
- (void)_switchAppGestureEndedWithCompletionType:(int)arg1 cumulativePercentage:(CGFloat)arg2;
...
- (void)_switcherGestureEndedWithCompletionType:(int)arg1 cumulativePercentage:(CGFloat)arg2;
...
- (BOOL)allowSystemGestureType:(unsigned int)arg1 atLocation:(CGPoint)arg2;
...
- (CGFloat)_contentRotationForOrientation:(int)arg1;
