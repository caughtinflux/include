...
- (void)animateFromEmergencyCallWithDuration:(CGFloat)arg1;
...
- (void)animateToShowingDeviceLock:(BOOL)arg1 duration:(CGFloat)arg2;
- (void)setShowingDeviceLock:(BOOL)arg1 animated:(BOOL)arg2;
- (void)setShowingDeviceLock:(BOOL)arg1;
- (void)setShowingDeviceLock:(BOOL)arg1 duration:(CGFloat)arg2 completion:(id)arg3 outDuration:(void)arg4;
- (void)setShowingDeviceLock:(BOOL)arg1 duration:(CGFloat)arg2 completion:(id)arg3;
- (id)deviceLockView;
...
- (void)animateDisplayIn:(CGFloat)arg1 middleDelay:(CGFloat)arg2 animateStatusBar:(BOOL)arg3;
...
- (void)setMiddleContentAlpha:(CGFloat)arg1;
