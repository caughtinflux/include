...
- (BOOL)_isHidingWindowLevel:(CGFloat)arg1;
...
- (void)startHidingWindowsExclusivelyFromLevel:(CGFloat)arg1 toLevel:(CGFloat)arg2 forContext:(id)arg3 reason:(id)arg4;
- (void)setAlpha:(CGFloat)arg1 forWindow:(id)arg2;
- (id)init;
