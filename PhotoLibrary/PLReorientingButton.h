...
- (CGAffineTransform)_transformForOrientation:(long long)arg1 rotationMode:(int)arg2;
...
- (_Bool)pointInside:(CGPoint)arg1 withEvent:(id)arg2;
- (CGRect)hitRect;
@property(nonatomic) _Bool autorotationEnabled; // @synthesize autorotationEnabled=_autorotationEnabled;
- (id)initWithFrame:(CGRect)arg1;
- (id)initWithFrame:(CGRect)arg1 isInButtonBar:(_Bool)arg2;
