...
@private
	...
	CGFloat _offset;
	CGFloat _sizeAdjustmentForKeyboard;
	CGFloat _slideAdjustmentForKeyboard;
...
+(BOOL)_shouldClampHorizontallyToCornerForContentSize:(CGSize)contentSize arrowOffset:(CGFloat)offset;
+(BOOL)_shouldClampVerticallyToTopCornerForPopoverSize:(CGSize)popoverSize arrowOffset:(CGFloat)offset;
+(BOOL)_shouldClampVerticallyToBottomCornerForPopoverSize:(CGSize)popoverSize arrowOffset:(CGFloat)offset;
+(id)_popoverBackgroundViewForContentSize:(CGSize)contentSize offset:(CGFloat)offset direction:(int)direction background:(int)background contentOrigin:(out CGPoint*)origin;
...
-(CGPathRef)_shadowPathForFrame:(CGRect)frame direction:(int)direction andOffset:(CGFloat)offset;
