...
-(void)setValue:(CGFloat)value animated:(BOOL)animated animationCurve:(int)curve;
...
-(CGFloat)_validatedValue:(CGFloat)value;
-(CGFloat)_validatedValueForPoint:(CGPoint)point includeTickMarks:(BOOL)marks;
