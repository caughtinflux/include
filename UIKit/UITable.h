...
-(void)_getRowCount:(int*)count andHeight:(CGFloat*)height beforeVisibleCellsForRows:(id)rows;
-(void)_animateRemovalOfCell:(id)cell atRow:(int)row col:(int)col viaEdge:(int)edge withAmountToSlideUp:(CGFloat*)slideUp;
-(void)_animateRemovalOfVisibleRows:(id)visibleRows viaEdge:(int)edge withAmountToSlideUp:(CGFloat*)slideUp;
-(void)_animateNewCells:(id)cells bySlidingUpAmount:(CGFloat)amount;
-(void)_animateNewCells:(id)cells bySlidingDownAmount:(CGFloat)amount;
-(CGFloat)_partOfRow:(int)row thatIsHidden:(BOOL)hidden;
