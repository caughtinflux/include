...
#import <PhotoLibrary/PLPhotoBrowserControllerDelegate-Protocol.h>
...
#import <PhotoLibrary/PLAssetContainerList-Protocol.h>
...
@property (nonatomic,readonly) id<PLAssetContainer> * currentAssetContainer; 
...
@property (assign,nonatomic) id<PUPhotoBrowserControllerDelegate> * delegate;                                    //@synthesize delegate=_delegate - In the implementation block
...
@property (nonatomic,readonly) id<PLAssetContainer> * currentAssetContainerForZoomTransition; 
