...
#import <SpringBoard/SBUIControlCenterButtonDelegate-Protocol.h>
...
@property(nonatomic, assign) id <SBUIControlCenterButtonDelegate> delegate; // @synthesize delegate=_delegate;
