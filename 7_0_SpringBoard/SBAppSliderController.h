...
- (void)animateDismissalToDisplayIdentifier:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)animatePresentationFromDisplayIdentifier:(id)arg1 withViews:(id)arg2 fromSide:(int)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (void)_layout;
