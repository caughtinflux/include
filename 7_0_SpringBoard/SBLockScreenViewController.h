...
- (void)removeOverlay:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)addOverlay:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
