...
- (void)_openURLCore:(id)arg1 display:(id)arg2 animating:(_Bool)arg3 sender:(id)arg4 additionalActivationFlags:(id)arg5 activationHandler:(CDUnknownBlockType)arg6;
- (void)_applicationOpenURL:(id)arg1 withApplication:(id)arg2 sender:(id)arg3 publicURLsOnly:(_Bool)arg4 animating:(_Bool)arg5 additionalActivationFlags:(id)arg6 activationHandler:(CDUnknownBlockType)arg7;
- (void)applicationOpenURL:(id)arg1 withApplication:(id)arg2 sender:(id)arg3 publicURLsOnly:(_Bool)arg4 animating:(_Bool)arg5 needsPermission:(_Bool)arg6 additionalActivationFlags:(id)arg7 activationHandler:(CDUnknownBlockType)arg8;
