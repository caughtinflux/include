...
- (_Bool)isUsingLegacyStyle;
- (void)activateRemoteAlertService:(NSString *)arg1 options:(NSDictionary *)arg2;
- (void)activateStarkRemoteAlertService:(NSString *)arg1 ofType:(NSString *)arg2;
...
- (_Bool)launchFromPushOrLocalBulletin:(BBBulletin *)arg1 origin:(int)arg2;
