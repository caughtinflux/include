...
- (void)_dismissForMainScreenAnimated:(_Bool)arg1 duration:(double)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)dismissAssistantViewIfNecessaryWithFade:(long long)arg1 ofDuration:(double)arg2 completion:(CDUnknownBlockType)arg3;
