...
@class NSTimer, SBCloseBoxView, SBFParallaxSettings, SBFolderIconBackgroundView, SBIcon, SBIconImageCrossfadeView, SBIconImageView, UIView<SBIconAccessoryView>, _UILegibilitySettings, _UILegibilityView;
...
- (void)setImageCrossfadeMorphFraction:(double)arg1;
