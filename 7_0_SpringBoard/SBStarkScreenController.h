...
- (void)_dismissSiriWithDuration:(double)arg1 animations:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
- (void)dismissSiriWithFade:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (void)dismissSiri:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
