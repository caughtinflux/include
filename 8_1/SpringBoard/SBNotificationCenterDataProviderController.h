...
- (void)setShowsInNotificationCenter:(BOOL)arg1 forDataProviderWithIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_setShowsInNotificationCenter:(BOOL)arg1 andUpdateExtensionOptInState:(BOOL)arg2 forDataProviderWithIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;
