...
+ (id)gridImageForNumberOfCells:(unsigned int)arg1 withCellImageProviderBlock:(CDUnknownBlockType)arg2;
+ (id)_gridImageForNumberOfCells:(unsigned int)arg1 withPreviousGridImage:(id)arg2 cellImageProviderBlock:(CDUnknownBlockType)arg3;
- (id)iconImageAtIndex:(unsigned int)arg1;
