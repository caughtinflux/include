...
- (id)peopleScrollView:(id)arg1 titleForSection:(unsigned int)arg2;
- (void)tappedExpandCollapseForItem:(id)arg1;
- (struct CGSize)peopleScrollView:(id)arg1 sizeForItem:(id)arg2 expanded:(BOOL)arg3;
- (struct CGSize)peopleScrollView:(id)arg1 sizeForPlaceholderForSection:(int)arg2;
- (id)peopleScrollView:(id)arg1 placeholderStringForEmptySection:(unsigned int)arg2;
