...
@property(nonatomic, getter=_isDisconnectingRemoteViewController, setter=_setDisconnectingRemoteViewController:) BOOL disconnectingRemoteViewController; // @synthesize disconnectingRemoteViewController=_disconnectingRemoteViewController;
@property(nonatomic, getter=_isRequestingRemoteViewController, setter=_setRequestingRemoteViewController:) BOOL requestingRemoteViewController; // @synthesize requestingRemoteViewController=_requestingRemoteViewController;
@property(nonatomic, getter=_isSnapshottingEnabled, setter=_setSnapshottingEnabled:) BOOL snapshottingEnabled; // @synthesize snapshottingEnabled=_snapshottingEnabled;
...
- (void)_disconnectRemoteViewControllerAndCoalesce:(BOOL)arg1 completionHandler:(CDUnknownBlockType)arg2;
