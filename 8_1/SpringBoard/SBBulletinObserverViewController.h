...
- (CDUnknownBlockType)widget:(id)arg1 didUpdatePreferredHeight:(float)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_updateSection:(id)arg1 forCategory:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) int supportedCategory;
...
- (void)addBulletin:(id)arg1 toSection:(id)arg2 forFeed:(unsigned int)arg3;
...
- (struct CGRect)_frameforViewWithContentForMode:(int)arg1;
...
- (id)initWithObserverFeed:(unsigned int)arg1 bulletinViewControllerClass:(Class)arg2;
