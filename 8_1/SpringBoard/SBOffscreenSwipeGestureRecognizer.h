...
- (BOOL)secondTouchQualifies:(const CDStruct_b59558ab *)arg1;
- (struct CGRect)activeScreenBounds;
- (BOOL)firstTouchQualifies:(const CDStruct_b59558ab *)arg1;
- (BOOL)_firstTouchInRange:(const CDStruct_b59558ab *)arg1;
- (void)dealloc;
- (void)reset;
