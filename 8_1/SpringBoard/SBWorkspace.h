...
- (id)_selectTransactionForAppActivationToApp:(id)arg1 canDeactivateAlerts:(BOOL)arg2 withResult:(CDUnknownBlockType)arg3;
...
- (id)_selectTransactionForAppActivationUnderMainScreenLock:(id)arg1 forRelaunch:(BOOL)arg2 withResult:(CDUnknownBlockType)arg3;
