...
- (BOOL)presentingController:(id <SBCoordinatedPresenting>)arg1 gestureRecognizerShouldBegin:(UIGestureRecognizer *)arg2;
- (BOOL)presentingController:(id <SBCoordinatedPresenting>)arg1 gestureRecognizer:(UIGestureRecognizer *)arg2 shouldReceiveTouch:(UITouch *)arg3;
